...
class Login extends Component {
	...
	return (
		<>
			<Helmet>
				<title>{`Login - Personifyco`}</title>
			</Helmet>
			<div className="container mx-auto lg:px-4 py-4 min-h-screen flex flex-col md:items-center md:justify-center">

				<div className="text-center mb-6">
					<Logo />
					<div className="text-3xl md:text-5xl relative font-medium text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-gray-600 mb-4">Personifyco<span className="font-normal "> beta</span>
			...
			<div className="align-bottom flex  transform transition-all sm:align-middle transition flex divide-x divide-gray-300 ">
			  ...
			  <Switch>
				...
				<a href={`https://personifycoai.webflow.io/`} className="block text-center bg-gray-100 text-gray-500 text-sm p-3 rounded-b-lg hover:bg-gray-200 cursor-pointer">
...
<form onSubmit={onLogin}>
					...
					<div className="flex flex-col">
						 ...
						 */}
						<a href={`https://personifycoai.webflow.io/`} className="mt-4 text-gray-400 text-sm">Forgot your password?</a>
					</div>
                    </div>
                  </form>
	  </>
